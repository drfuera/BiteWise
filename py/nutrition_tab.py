...
class NutrientGraph(Gtk.DrawingArea):
    ...
    def on_draw(self, widget, cr):
        ...
        # Graph configuration
        nutrients = ['carbs', 'sugar', 'fat', 'protein', 'fiber', 'salt']
        colors = [
            (0.4, 0.7, 1.0, 1.0), (0.6, 1.0, 0.6, 1.0), (1.0, 0.6, 0.6, 1.0),
            (1.0, 0.8, 0.6, 1.0), (0.8, 0.6, 1.0, 1.0), (0.6, 0.8, 1.0, 1.0)
        ]
    ...
    def _load_and_process_data(self):
        ...
        for entry in entries:
            ...
            if date not in self.nutrient_data:
                self.nutrient_data[date] = {n: 0.0 for n in ['carbs', 'sugar', 'fat', 'protein', 'fiber', 'salt']}
